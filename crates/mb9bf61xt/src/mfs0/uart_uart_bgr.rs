...
pub type R = crate::R<UART_UART_BGR_SPEC>;
#[doc = "Register `UART_BGR` writer"]
pub type W = crate::W<UART_UART_BGR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bgr0(&mut self) -> BGR0_W<UART_UART_BGR_SPEC> {
        BGR0_W::new(self, 0)
    }
    #[doc = "Bits 8:14 - Baud Rate Generator Registers 1"]
    #[inline(always)]
    #[must_use]
    pub fn bgr1(&mut self) -> BGR1_W<UART_UART_BGR_SPEC> {
        BGR1_W::new(self, 8)
    }
    #[doc = "Bit 15 - External clock select bit"]
    #[inline(always)]
    #[must_use]
    pub fn ext(&mut self) -> EXT_W<UART_UART_BGR_SPEC> {
        EXT_W::new(self, 15)
    }
...
#[doc = "Baud Rate Generator Registers\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`uart_uart_bgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`uart_uart_bgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct UART_UART_BGR_SPEC;
impl crate::RegisterSpec for UART_UART_BGR_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [`uart_uart_bgr::R`](R) reader structure"]
impl crate::Readable for UART_UART_BGR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`uart_uart_bgr::W`](W) writer structure"]
impl crate::Writable for UART_UART_BGR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets UART_BGR to value 0"]
impl crate::Resettable for UART_UART_BGR_SPEC {
