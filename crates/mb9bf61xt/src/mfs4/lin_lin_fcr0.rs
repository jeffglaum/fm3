#[doc = "Register `LIN_FCR0` reader"]
pub type R = crate::R<LIN_LIN_FCR0_SPEC>;
#[doc = "Register `LIN_FCR0` writer"]
pub type W = crate::W<LIN_LIN_FCR0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fe1(&mut self) -> FE1_W<LIN_LIN_FCR0_SPEC> {
        FE1_W::new(self, 0)
    }
    #[doc = "Bit 1 - FIFO2 operation enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn fe2(&mut self) -> FE2_W<LIN_LIN_FCR0_SPEC> {
        FE2_W::new(self, 1)
    }
    #[doc = "Bit 2 - FIFO1 reset bit"]
    #[inline(always)]
    #[must_use]
    pub fn fcl1(&mut self) -> FCL1_W<LIN_LIN_FCR0_SPEC> {
        FCL1_W::new(self, 2)
    }
    #[doc = "Bit 3 - FIFO2 reset bit"]
    #[inline(always)]
    #[must_use]
    pub fn fcl2(&mut self) -> FCL2_W<LIN_LIN_FCR0_SPEC> {
        FCL2_W::new(self, 3)
    }
    #[doc = "Bit 4 - FIFO pointer save bit"]
    #[inline(always)]
    #[must_use]
    pub fn fset(&mut self) -> FSET_W<LIN_LIN_FCR0_SPEC> {
        FSET_W::new(self, 4)
    }
    #[doc = "Bit 5 - FIFO pointer reload bit"]
    #[inline(always)]
    #[must_use]
    pub fn fld(&mut self) -> FLD_W<LIN_LIN_FCR0_SPEC> {
        FLD_W::new(self, 5)
    }
...
#[doc = "FIFO Control Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lin_lin_fcr0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lin_lin_fcr0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LIN_LIN_FCR0_SPEC;
impl crate::RegisterSpec for LIN_LIN_FCR0_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`lin_lin_fcr0::R`](R) reader structure"]
impl crate::Readable for LIN_LIN_FCR0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`lin_lin_fcr0::W`](W) writer structure"]
impl crate::Writable for LIN_LIN_FCR0_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets LIN_FCR0 to value 0"]
impl crate::Resettable for LIN_LIN_FCR0_SPEC {
