#[doc = "Register `CSIO_FCR1` reader"]
pub type R = crate::R<CSIO_CSIO_FCR1_SPEC>;
#[doc = "Register `CSIO_FCR1` writer"]
pub type W = crate::W<CSIO_CSIO_FCR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsel(&mut self) -> FSEL_W<CSIO_CSIO_FCR1_SPEC> {
        FSEL_W::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit FIFO interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn ftie(&mut self) -> FTIE_W<CSIO_CSIO_FCR1_SPEC> {
        FTIE_W::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit FIFO data request bit"]
    #[inline(always)]
    #[must_use]
    pub fn fdrq(&mut self) -> FDRQ_W<CSIO_CSIO_FCR1_SPEC> {
        FDRQ_W::new(self, 2)
    }
    #[doc = "Bit 3 - Received FIFO idle detection enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn friie(&mut self) -> FRIIE_W<CSIO_CSIO_FCR1_SPEC> {
        FRIIE_W::new(self, 3)
    }
    #[doc = "Bit 4 - Re-transmission data lost detect enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn flste(&mut self) -> FLSTE_W<CSIO_CSIO_FCR1_SPEC> {
        FLSTE_W::new(self, 4)
    }
...
#[doc = "FIFO Control Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`csio_csio_fcr1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`csio_csio_fcr1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CSIO_CSIO_FCR1_SPEC;
impl crate::RegisterSpec for CSIO_CSIO_FCR1_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`csio_csio_fcr1::R`](R) reader structure"]
impl crate::Readable for CSIO_CSIO_FCR1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`csio_csio_fcr1::W`](W) writer structure"]
impl crate::Writable for CSIO_CSIO_FCR1_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets CSIO_FCR1 to value 0x04"]
impl crate::Resettable for CSIO_CSIO_FCR1_SPEC {
