#[doc = "Register `PWM_TMCR` reader"]
pub type R = crate::R<PWM_PWM_TMCR_SPEC>;
#[doc = "Register `PWM_TMCR` writer"]
pub type W = crate::W<PWM_PWM_TMCR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn strg(&mut self) -> STRG_W<PWM_PWM_TMCR_SPEC> {
        STRG_W::new(self, 0)
    }
    #[doc = "Bit 1 - Count operation enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn cten(&mut self) -> CTEN_W<PWM_PWM_TMCR_SPEC> {
        CTEN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Mode selection bit"]
    #[inline(always)]
    #[must_use]
    pub fn mdse(&mut self) -> MDSE_W<PWM_PWM_TMCR_SPEC> {
        MDSE_W::new(self, 2)
    }
    #[doc = "Bit 3 - Output polarity specification bit"]
    #[inline(always)]
    #[must_use]
    pub fn osel(&mut self) -> OSEL_W<PWM_PWM_TMCR_SPEC> {
        OSEL_W::new(self, 3)
    }
    #[doc = "Bits 4:6 - Timer function selection bits"]
    #[inline(always)]
    #[must_use]
    pub fn fmd(&mut self) -> FMD_W<PWM_PWM_TMCR_SPEC> {
        FMD_W::new(self, 4)
    }
    #[doc = "Bits 8:9 - Trigger input edge selection bits"]
    #[inline(always)]
    #[must_use]
    pub fn egs(&mut self) -> EGS_W<PWM_PWM_TMCR_SPEC> {
        EGS_W::new(self, 8)
    }
    #[doc = "Bit 10 - Pulse output mask bit"]
    #[inline(always)]
    #[must_use]
    pub fn pmsk(&mut self) -> PMSK_W<PWM_PWM_TMCR_SPEC> {
        PMSK_W::new(self, 10)
    }
    #[doc = "Bit 11 - Restart enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn rtgen(&mut self) -> RTGEN_W<PWM_PWM_TMCR_SPEC> {
        RTGEN_W::new(self, 11)
    }
    #[doc = "Bits 12:14 - Count clock selection bit"]
    #[inline(always)]
    #[must_use]
    pub fn cks2_0(&mut self) -> CKS2_0_W<PWM_PWM_TMCR_SPEC> {
...
#[doc = "Timer Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwm_pwm_tmcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwm_pwm_tmcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PWM_PWM_TMCR_SPEC;
impl crate::RegisterSpec for PWM_PWM_TMCR_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [`pwm_pwm_tmcr::R`](R) reader structure"]
impl crate::Readable for PWM_PWM_TMCR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`pwm_pwm_tmcr::W`](W) writer structure"]
impl crate::Writable for PWM_PWM_TMCR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets PWM_TMCR to value 0"]
impl crate::Resettable for PWM_PWM_TMCR_SPEC {
