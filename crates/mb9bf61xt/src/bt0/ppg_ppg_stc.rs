#[doc = "Register `PPG_STC` reader"]
pub type R = crate::R<PPG_PPG_STC_SPEC>;
#[doc = "Register `PPG_STC` writer"]
pub type W = crate::W<PPG_PPG_STC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn udir(&mut self) -> UDIR_W<PPG_PPG_STC_SPEC> {
        UDIR_W::new(self, 0)
    }
    #[doc = "Bit 2 - Trigger interrupt request bit"]
    #[inline(always)]
    #[must_use]
    pub fn tgir(&mut self) -> TGIR_W<PPG_PPG_STC_SPEC> {
        TGIR_W::new(self, 2)
    }
    #[doc = "Bit 4 - Underflow interrupt request enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn udie(&mut self) -> UDIE_W<PPG_PPG_STC_SPEC> {
        UDIE_W::new(self, 4)
    }
    #[doc = "Bit 6 - Trigger interrupt request enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn tgie(&mut self) -> TGIE_W<PPG_PPG_STC_SPEC> {
        TGIE_W::new(self, 6)
    }
...
#[doc = "Status Control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ppg_ppg_stc::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ppg_ppg_stc::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PPG_PPG_STC_SPEC;
impl crate::RegisterSpec for PPG_PPG_STC_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`ppg_ppg_stc::R`](R) reader structure"]
impl crate::Readable for PPG_PPG_STC_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ppg_ppg_stc::W`](W) writer structure"]
impl crate::Writable for PPG_PPG_STC_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets PPG_STC to value 0"]
impl crate::Resettable for PPG_PPG_STC_SPEC {
