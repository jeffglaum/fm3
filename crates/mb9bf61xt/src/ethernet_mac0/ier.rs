...
#[doc = "Field `TIE` reader - Transmit Interrupt"]
pub type TIE_R = crate::BitReader;
#[doc = "Field `TIE` writer - Transmit Interrupt"]
pub type TIE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TSE` reader - Transmit Process Stopped"]
pub type TSE_R = crate::BitReader;
#[doc = "Field `TSE` writer - Transmit Process Stopped"]
pub type TSE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TUE` reader - Transmit Buffer Unavailable"]
pub type TUE_R = crate::BitReader;
#[doc = "Field `TUE` writer - Transmit Buffer Unavailable"]
pub type TUE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TJE` reader - Transmit Jabber Timeout"]
pub type TJE_R = crate::BitReader;
#[doc = "Field `TJE` writer - Transmit Jabber Timeout"]
pub type TJE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OVE` reader - Receive Overflow Enable"]
pub type OVE_R = crate::BitReader;
#[doc = "Field `UNE` reader - Transmit underflow Enable"]
pub type UNE_R = crate::BitReader;
#[doc = "Field `UNE` writer - Transmit underflow Enable"]
...
#[doc = "Field `RSE` reader - Receive Process Stopped Enable"]
pub type RSE_R = crate::BitReader;
#[doc = "Field `RSE` writer - Receive Process Stopped Enable"]
...
impl R {
    ...
    #[doc = "Bit 4 - Receive Overflow Enable"]
    #[inline(always)]
    pub fn ove(&self) -> OVE_R {
        OVE_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Transmit underflow Enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - Receive Process Stopped Enable"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tse(&mut self) -> TSE_W<IER_SPEC> {
        TSE_W::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit Buffer Unavailable"]
    #[inline(always)]
    #[must_use]
    pub fn tue(&mut self) -> TUE_W<IER_SPEC> {
        TUE_W::new(self, 2)
    }
    #[doc = "Bit 3 - Transmit Jabber Timeout"]
    #[inline(always)]
    #[must_use]
    pub fn tje(&mut self) -> TJE_W<IER_SPEC> {
        TJE_W::new(self, 3)
    }
    #[doc = "Bit 5 - Transmit underflow Enable"]
    #[inline(always)]
    #[must_use]
    pub fn une(&mut self) -> UNE_W<IER_SPEC> {
        UNE_W::new(self, 5)
    }
    #[doc = "Bit 6 - Receive Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rie(&mut self) -> RIE_W<IER_SPEC> {
        RIE_W::new(self, 6)
    }
    #[doc = "Bit 7 - Receive Buffer Unavailable Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rue(&mut self) -> RUE_W<IER_SPEC> {
        RUE_W::new(self, 7)
    }
    #[doc = "Bit 8 - Receive Process Stopped Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rse(&mut self) -> RSE_W<IER_SPEC> {
        RSE_W::new(self, 8)
    }
    #[doc = "Bit 9 - Receive Watchdog Timeout Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rwe(&mut self) -> RWE_W<IER_SPEC> {
        RWE_W::new(self, 9)
    }
    #[doc = "Bit 10 - Early Transmit Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ete(&mut self) -> ETE_W<IER_SPEC> {
        ETE_W::new(self, 10)
    }
    #[doc = "Bit 13 - Fatal Bus Error Enable"]
    #[inline(always)]
    #[must_use]
    pub fn fbe(&mut self) -> FBE_W<IER_SPEC> {
        FBE_W::new(self, 13)
    }
    #[doc = "Bit 14 - Early Receive Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ere(&mut self) -> ERE_W<IER_SPEC> {
        ERE_W::new(self, 14)
    }
    #[doc = "Bit 15 - Abnormal Interrupt Summary Enable"]
    #[inline(always)]
    #[must_use]
    pub fn aie(&mut self) -> AIE_W<IER_SPEC> {
        AIE_W::new(self, 15)
    }
    #[doc = "Bit 16 - Normal Interrupt Summary Enable"]
    #[inline(always)]
    #[must_use]
    pub fn nie(&mut self) -> NIE_W<IER_SPEC> {
        NIE_W::new(self, 16)
    }
