...
pub type R = crate::R<RXIPV4_FRAG_FRMS_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<RXIPV4_FRAG_FRMS_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "Number of good IPv4 datagrams with fragmentation\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rxipv4_frag_frms::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
