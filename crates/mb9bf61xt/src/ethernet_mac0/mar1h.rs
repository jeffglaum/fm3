#[doc = "Register `MAR1H` reader"]
pub type R = crate::R<MAR1H_SPEC>;
#[doc = "Register `MAR1H` writer"]
pub type W = crate::W<MAR1H_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn a32(&mut self) -> A32_W<MAR1H_SPEC> {
        A32_W::new(self, 0)
    }
    #[doc = "Bit 1 - AD\\[33\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a33(&mut self) -> A33_W<MAR1H_SPEC> {
        A33_W::new(self, 1)
    }
    #[doc = "Bit 2 - AD\\[34\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a34(&mut self) -> A34_W<MAR1H_SPEC> {
        A34_W::new(self, 2)
    }
    #[doc = "Bit 3 - AD\\[35\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a35(&mut self) -> A35_W<MAR1H_SPEC> {
        A35_W::new(self, 3)
    }
    #[doc = "Bit 4 - AD\\[36\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a36(&mut self) -> A36_W<MAR1H_SPEC> {
        A36_W::new(self, 4)
    }
    #[doc = "Bit 5 - AD\\[37\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a37(&mut self) -> A37_W<MAR1H_SPEC> {
        A37_W::new(self, 5)
    }
    #[doc = "Bit 6 - AD\\[38\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a38(&mut self) -> A38_W<MAR1H_SPEC> {
        A38_W::new(self, 6)
    }
    #[doc = "Bit 7 - AD\\[39\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a39(&mut self) -> A39_W<MAR1H_SPEC> {
        A39_W::new(self, 7)
    }
    #[doc = "Bit 8 - AD\\[40\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a40(&mut self) -> A40_W<MAR1H_SPEC> {
        A40_W::new(self, 8)
    }
    #[doc = "Bit 9 - AD\\[41\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a41(&mut self) -> A41_W<MAR1H_SPEC> {
        A41_W::new(self, 9)
    }
    #[doc = "Bit 10 - AD\\[42\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a42(&mut self) -> A42_W<MAR1H_SPEC> {
        A42_W::new(self, 10)
    }
    #[doc = "Bit 11 - AD\\[43\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a43(&mut self) -> A43_W<MAR1H_SPEC> {
        A43_W::new(self, 11)
    }
    #[doc = "Bit 12 - AD\\[44\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a44(&mut self) -> A44_W<MAR1H_SPEC> {
        A44_W::new(self, 12)
    }
    #[doc = "Bit 13 - AD\\[45\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a45(&mut self) -> A45_W<MAR1H_SPEC> {
        A45_W::new(self, 13)
    }
    #[doc = "Bit 14 - AD\\[46\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a46(&mut self) -> A46_W<MAR1H_SPEC> {
        A46_W::new(self, 14)
    }
    #[doc = "Bit 15 - AD\\[47\\]"]
    #[inline(always)]
    #[must_use]
    pub fn a47(&mut self) -> A47_W<MAR1H_SPEC> {
        A47_W::new(self, 15)
    }
    #[doc = "Bits 24:29 - Mask Byte Control"]
    #[inline(always)]
    #[must_use]
    pub fn mbc(&mut self) -> MBC_W<MAR1H_SPEC> {
        MBC_W::new(self, 24)
    }
    #[doc = "Bit 30 - Source Address"]
    #[inline(always)]
    #[must_use]
    pub fn sa(&mut self) -> SA_W<MAR1H_SPEC> {
        SA_W::new(self, 30)
    }
    #[doc = "Bit 31 - Address Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ae(&mut self) -> AE_W<MAR1H_SPEC> {
        AE_W::new(self, 31)
    }
...
#[doc = "MAC Address1 Register -High\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`mar1h::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`mar1h::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MAR1H_SPEC;
impl crate::RegisterSpec for MAR1H_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mar1h::R`](R) reader structure"]
impl crate::Readable for MAR1H_SPEC {}
#[doc = "`write(|w| ..)` method takes [`mar1h::W`](W) writer structure"]
impl crate::Writable for MAR1H_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MAR1H to value 0xffff"]
impl crate::Resettable for MAR1H_SPEC {
