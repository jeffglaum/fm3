#[doc = "Register `EP1S` reader"]
pub type R = crate::R<EP1S_SPEC>;
#[doc = "Register `EP1S` writer"]
pub type W = crate::W<EP1S_SPEC>;
...
impl R {
    #[doc = "Bits 0:8 - packet SIZE"]
    #[inline(always)]
    pub fn size(&self) -> SIZE_R {
        SIZE_R::new(self.bits & 0x01ff)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spk(&mut self) -> SPK_W<EP1S_SPEC> {
        SPK_W::new(self, 9)
    }
    #[doc = "Bit 10 - Packet Transfer Interrupt Request bit"]
    #[inline(always)]
    #[must_use]
    pub fn drq(&mut self) -> DRQ_W<EP1S_SPEC> {
        DRQ_W::new(self, 10)
    }
    #[doc = "Bit 13 - Short Packet Interrupt Enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn spkie(&mut self) -> SPKIE_W<EP1S_SPEC> {
        SPKIE_W::new(self, 13)
    }
    #[doc = "Bit 14 - Packet Transfer Interrupt Enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn drqie(&mut self) -> DRQIE_W<EP1S_SPEC> {
        DRQIE_W::new(self, 14)
    }
    #[doc = "Bit 15 - Send/Receive Buffer Initialization bit"]
    #[inline(always)]
    #[must_use]
    pub fn bfini(&mut self) -> BFINI_W<EP1S_SPEC> {
        BFINI_W::new(self, 15)
    }
...
#[doc = "EP1 Status Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ep1s::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ep1s::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EP1S_SPEC;
impl crate::RegisterSpec for EP1S_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ep1s::R`](R) reader structure"]
impl crate::Readable for EP1S_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ep1s::W`](W) writer structure"]
impl crate::Writable for EP1S_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets EP1S to value 0x8000"]
impl crate::Resettable for EP1S_SPEC {
